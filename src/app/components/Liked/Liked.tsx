...
export const Liked = () => {
    ...
    const fillteredSearch=context.searchedPhotos.photos.filter(item=>item.liked)
     ...
     const memoizedPhotos = useMemo(() => {
        return filtered.map((photo, index) => (
          ...
          <div key={index} className={styles.photoWrapper}>
            ...
            <div className={styles.heart} onClick={() => toggleLike(photo.id,context.setPhotos)}>
      ...
      const memoizedPhoto = useMemo(() => {
        return fillteredSearch.map((photo, index) => (
          ...
          <div key={index} className={styles.photoWrapper}>
            ...
            <div className={styles.heart} onClick={() => toggleLike(photo.id,context.setSearchedPhotos)}>
            <Image src={photo.liked ? "/images/heartred.svg" : "/images/heart.svg"} alt="like" key={index} width={25} height={25} />
            </div>
            <Image
              src={photo.src.original}
